...
!
         rnorm = sqrt(rnorm)
           rnorm0 = rnorm
!
       write(*,*) 'mfnk: ncells=',ncells
       write(*,*) 'mfnk: rnorm0=', rnorm
!
       write(*,*) 'mfnk:  eps, ynorm=', eps, ynorm
!
           if(rnorm.lt.eps*ynorm) then
              write(*,*)'mfnk:  solution converged without iteration'
              return
           endif
!
      endif
...
!
   write(*,*) 'mfnk: calling gmres'
   
      call gmres_3dmhd(tol_GMRES,ncells)
!
   write(*,*) 'mfnk:  returning from gmres'
...
!
 9926 format(" mfnk failed to converge, numit=",i4,"rnorm=",1pe10.2)
      return
 1025 continue
  write(*,*) 'mfnk: numit, dxnorm, rnorm=',numit,dxnorm,rnorm
!
